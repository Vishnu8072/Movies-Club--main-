...
function applyGlowingEffect() {
  ...
  var intervalId = setInterval(function () {
    ...
    for (var i = 0; i < letters.length; i++) {
      ...
      newText += "<span style=\"color: ".concat(color, "; text-shadow: 0 0 10px ").concat(color, ";\">").concat(letters[i], "</span>");
    }
...
applyGlowingEffect(); // below code is for select element for responsive design
